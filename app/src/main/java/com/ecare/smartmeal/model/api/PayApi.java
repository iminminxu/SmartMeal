...
public class PayApi {
    ...
    //apiService
    private PayApiService apiService;
    //默认超时时间
    ...
    private static class ProjectApiHolder {
        private static final PayApi projectApi = new PayApi();
    }
     ...
     */
    public PayApiService getApiService() {
        return apiService;
    }
}
